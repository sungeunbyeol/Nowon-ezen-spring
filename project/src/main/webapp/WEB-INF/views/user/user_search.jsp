...
<c:if test="${param.mode.equals('password')}">
	<td>
		<input type="text" name="u_email" placeholder="이메일을 입력해 주세요." tabindex="1" style="width:350px;height:50px">
	</td>
</c:if>
<tr>
	<td>
		<input type="text" name="u_name" placeholder="이름을 입력해 주세요." tabindex="2" style="width:350px;height:50px">
	</td>
</tr>
<tr>
	<td>
		<input type="text" name="u_tel" placeholder="전화번호를 입력해 주세요." tabindex="3" style="width:350px;height:50px">
	</td>
</tr>
<tr>
	<td>
	<c:if test="${param.mode.equals('email')}">
		<button type="submit" formaction="user_search_email_ok" 
