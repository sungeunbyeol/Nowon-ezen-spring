...
<article style="margin-top:50px;">
	...
	<table align="center" border="1" width="500px">
		...
		<tr>	 
			<td style="width:10%;">${dto.u_email}</td> 
			<td style="width:5%;">${dto.u_name}</td>  
			<td style="width:20%;">
				<input class="search-input" type="text" name="u_black" value="${dto.u_black}">
			</td>
			<td style="width:7%;">
		   		<input class="search-input" type="hidden" name="u_num" value="${dto.u_num}">
		   		<input class="search-input" type="submit" value="수정">
			</td>
			<td style="width:7%;">
				<button type="button" class="search-input" onclick="location.href='deleteBlackUser?u_num=${dto.u_num}'">해제</button> 
			</td>
			</tr>  
		</c:forEach> 
	</table>
