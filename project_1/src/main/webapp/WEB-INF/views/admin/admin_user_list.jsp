...
<article style="margin-top:50px;">
		...
		<tr>
			<td style="width:5%;" align = "center">${dto.u_num}</td>
			<td style="width:5%;" align = "center">${dto.u_name}</td>
			<td style="width:10%;" align = "center">${dto.u_email}</td>
			<td style="width:7%;" align = "center">${dto.u_nickname}</td>
			<td style="width:10%;" align = "center">${dto.u_tel }</td>
			<td style="width:7%;" align = "center">${dto.u_birth}</td>   
			<td style="width:5%;" align = "center">${dto.a_level}</td>
		<form name="f_updateBlack" method="post" action="insertBlackUser">
			<td style="width:20%;">
				<input class="search-input" type="text" name="u_black" value="${dto.u_black}">
			</td>
			...
			<td style="width:5%;">
			<button class="search-input" onclick="location.href = 'deleteUser?u_num=${dto.u_num}'">삭제</button>
			</td>
		</tr>  
		</c:forEach>
	</table>
