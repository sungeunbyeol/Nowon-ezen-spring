	...
	<table border="0" width="280" align="center">
		...
		<tr>
			<td colspan="2" align="center">
				<input type="password" name="u_password" placeholder="새 비밀번호를 입력해 주세요." tabindex="1" style="width:350px;height:50px">
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center">
				<input type="password" name="u_password2" placeholder="새 비밀번호를 한 번 더 입력해 주세요." tabindex="2" style="width:350px;height:50px">
			</td>
		</tr>
		<tr>
			<td>
